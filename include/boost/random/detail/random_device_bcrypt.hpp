...
public:
        ...
        : hProv_(NULL)
    {
        ...
        boost::detail::winapi::NTSTATUS_ status =
            boost::detail::winapi::BCryptOpenAlgorithmProvider(
                &hProv_, 
                boost::detail::winapi::BCRYPT_RNG_ALGORITHM_,
                NULL,
                0);
    ...
    ~random_device_bcrypt() BOOST_NOEXCEPT
    {
        if (hProv_)
        {
            ignore_unused(boost::detail::winapi::BCryptCloseAlgorithmProvider(hProv_, 0));
        }
    }
    ...
    result_type operator()()
    {
        ...
        boost::detail::winapi::NTSTATUS_ status =
            boost::detail::winapi::BCryptGenRandom(
                hProv_,
                reinterpret_cast<boost::detail::winapi::PUCHAR_>(&result),
                sizeof(result),
                0);
...
private:
    boost::detail::winapi::BCRYPT_ALG_HANDLE_ hProv_;
};
